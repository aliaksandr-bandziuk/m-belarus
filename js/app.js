(() => {
    ...
    const header_isMobile = {
        ...
        any: function() {
            return header_isMobile.Android() || header_isMobile.BlackBerry() || header_isMobile.iOS() || header_isMobile.Opera() || header_isMobile.Windows();
        }
    };
    if (header_isMobile.any()) {
